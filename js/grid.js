...
class Grid {
    ...
    reset() {
        ...
        // reset time of algorithm execution
        document.getElementById("algorithm_time").innerHTML = 0
        document.getElementById("massege_text").innerHTML = "ساخته شده با عشق"
        document.getElementById("number_of_opened_node").innerHTML = 0
